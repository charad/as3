 ...
 * @since	Jul 24, 2011, at 8:14:35 PM
 ********************************
 **/
package be.arnordhaenens.views.mediators.notifications
{
	...
	/**
	 * Class	SendNotificationMediator
	 * @author	D'Haenens Arnor
	 * @since	Jul 24, 2011, at 8:14:35 PM
	 * @see		be.arnordhaenens.views.mediators.notifications.SendNotificationMediator
	 **/
	public class SendNotificationMediator extends Mediator
	{
		/**
		 * Variables
		 **/
		[Inject]public var view:SendNotificationComponent;
		
		/**
		 * Constructor
		 **/
		public function SendNotificationMediator()
		{
			super();
		}
		...
		{
			//dispatch event notification is removed
			dispatch(new NotificationEvent(NotificationEvent.REMOVE_NOTIFICATION));
			
			//unmap listeners
			eventMap.unmapListeners();
			
			mediatorMap.unmapView(SendNotificationComponent);
			mediatorMap.removeMediatorByView(SendNotificationComponent);
		...
		{
			//call the view's public function 
