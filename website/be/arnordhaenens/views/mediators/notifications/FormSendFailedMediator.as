 ...
 * @since	Jul 24, 2011, at 9:26:27 PM
 ********************************
 **/
package be.arnordhaenens.views.mediators.notifications
{
	...
	/**
	 * Class	FormSendFailedMediator
	 * @author	D'Haenens Arnor
	 * @since	Jul 24, 2011, at 9:26:27 PM
	 * @see		be.arnordhaenens.views.mediators.notifications.FormSendFailedMediator
	 **/
	public class FormSendFailedMediator extends Mediator
	{
		/**
		 * Variables
		 **/
		[Inject]public var view:FormSendFailedComponent;
		
		/**
		 * Constructor
		 **/
		public function FormSendFailedMediator()
		{
			super();
		}
		...
		override public function onRemove():void
		{
			...
			//mediatormap
			mediatorMap.unmapView(FormSendFailedComponent);
			mediatorMap.removeMediatorByView(FormSendFailedComponent);
